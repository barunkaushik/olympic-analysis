...
def data_over_time(df, col):
    stat_over_time = df.drop_duplicates(['Year', col])['Year'].value_counts().reset_index().sort_values('index')
    stat_over_time.rename(columns={'index': 'edition', 'Year': col}, inplace=True)
    return stat_over_time
